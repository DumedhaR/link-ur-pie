...
export default function WhyUsArea() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative py-25 overflow-visible w-full min-h-[750px] flex flex-col font-semibold items-center text-primary-foreground"
    >
      {/* BG Color Layer */}
      ...
      {/* Top Heading */}
      <h1 className="absolute left-20 max-w-3xl text-5xl z-20 pointer-events-none text-left">
